...
def config_aliengo(Cnfg: Union[Cfg, Meta]):
    """Configure WTW for Unitree AlienGo robot."""

    _ = Cnfg.init_state
    _.pos = [0.0, 0.0, 0.42]  # x,y,z [m] — AlienGo standing height
    ...
    _ = Cnfg.control
    _.control_type = 'P'                 # start with simple PD, not actuator_net
    _.stiffness = {'joint': 50.}         # [N*m/rad] — higher than Go1 (AlienGo is heavier)
    ...
    _.base_height_target = 0.35          # AlienGo standing height target
    ...
    _ = Cnfg.terrain
    _.mesh_type = 'plane'                # Start with flat terrain
