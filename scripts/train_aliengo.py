def train_aliengo(headless=True):
    ...
    from go1_gym.envs.aliengo.aliengo_config import config_aliengo
    from go1_gym.envs.aliengo import VelocityTrackingEasyEnv
    ...
    # ---- Control ----
    Cfg.control.control_type = "P"   # PD control (use "actuator_net" for actuator network)
    ...
    Cfg.terrain.mesh_type = "plane"     # Flat terrain for initial AlienGo training
    ...
    Cfg.rewards.terminal_body_height = 0.20    # AlienGo body height termination
    ...
    Cfg.rewards.base_height_target = 0.35   # AlienGo standing height
